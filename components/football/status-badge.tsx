...
export function StatusBadge({fixture, className}: {fixture: Pick<FixtureSummary, 'state' | 'minute' | 'startingAt'>; className?: string}) {
    ...
    switch (fixture.state) {
        case 'live':
            return <Badge variant="accent" className={className}>{fixture.minute !== null ? t('live', {minute: fixture.minute}) : t('liveNoMinute')}</Badge>;
        case 'extra_time':
            return <Badge variant="accent" className={className}>{fixture.minute !== null ? t('extraTime', {minute: fixture.minute}) : t('liveNoMinute')}</Badge>;
        case 'penalties':
