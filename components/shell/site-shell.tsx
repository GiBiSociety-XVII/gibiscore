 ...
 */
export async function SiteShell({children, rail, wide = false, sidebar = true, navigation}: {children: ReactNode; rail?: ReactNode; wide?: boolean; /** Hide the competitions column and chips: full-width tools (fantasy). */ sidebar?: boolean; navigation?: Navigation}) {
